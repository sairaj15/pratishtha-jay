...
import 'package:pratishtha/screens/rules/editPointsRulesPage.dart';
...
class _EditPointsState extends State<EditPoints> {
  ...
  PointsServices pointServices = PointsServices();

  @override
  void initState() {
    super.initState();
    pointsTextEditingController.text = "0";
  }
    ...
    return checkConection(
      child: Scaffold(
        appBar: AppBar(
          ...
          actions: [
            rulesIconButton(context: context, popUpPage: EditPointsRulesPage())
          ],
        ),
        body: FutureBuilder(
            ...
            builder: (context, AsyncSnapshot snapshot) {
              if (snapshot.hasData) {
                  ...
                  child:
                    ...
                    return Column(
                      children: [
                                              ...
                                              children: [
                                                ...
                                                IconButton(
                                                    onPressed: () {
                                                      ...
                                                      // List<ListTile> tempSearchResults = [];
                        ...
                        ElevatedButton(
                            onPressed: () async {
                              if (int.parse(pointsTextEditingController.text
                                          .trim()) !=
                                      0 &&
                                  pointsTextEditingController.text != "") {
                                ...
                                (int.parse(pointsTextEditingController.text)<0 && -int.parse(pointsTextEditingController.text)>selectedUser!.points)
                                ){
                                  Fluttertoast.showToast(
                                      msg: "The selected user doesn't have enough points",
                                      toastLength: Toast.LENGTH_LONG
                                  );
                                }
                                else {
                                  await pointServices.addPoints(
                                      ...
                                      value: pointsTextEditingController.text,
                                      reason: reasonTextEditingController.text);
                                  Fluttertoast.showToast(
                                      msg: "Points updated succesfully",
                                      toastLength: Toast.LENGTH_LONG);
                                  setState(() {
                                    selectedUser = null;
                                    pointsTextEditingController.text = "0";
                                ...
                                Fluttertoast.showToast(
                                  ...
                                  0) {
                                Fluttertoast.showToast(
                                    msg: "Please enter some points first",
                                    toastLength: Toast.LENGTH_LONG);
                              }
                            },
                ...
                //print("editPoints error: ${snapshot.error}");
