...
String getFormattedDateRange({DateTime? dateFrom, DateTime? dateTo}){
...
String getFullFormattedDateRange({DateTime? dateFrom, DateTime? dateTo}){
...
String getFormattedTimeRange({DateTime? dateFrom, DateTime? dateTo}){
